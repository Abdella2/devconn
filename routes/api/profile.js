...
router.get('/github/:username', (req, res) => {
  const { clientId, clientSecret, host, perPage, sort, method } =
    config.get('github');
  try {
    const options = {
      url: `${host}/users/${req.params.username}/repos?per_page=${perPage}&sort=${sort}&client_id=${clientId}&client_secret=${clientSecret}`,
      method,
